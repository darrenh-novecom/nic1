...
```
DEPLOY_ENV=prod
DEPLOY_HOST=nic1.novecom.com.au
DEPLOY_PORT=22
DEPLOY_USER=plone
...
Deploy the stack defined in `devops/stacks/nic1.novecom.com.au.yml` to the remote server with:
