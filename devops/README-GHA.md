...
2. Go to your repository at [darrenhnovecom/nic1](https://github.com/darrenhnovecom/nic1).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `nic1.novecom.com.au` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | nic1.novecom.com.au | The hostname or IP address of your Docker Swarm manager. |
...
- [Backend Tests Workflow](https://github.com/darrenhnovecom/nic1/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/darrenhnovecom/nic1/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`darrenhnovecom/nic1-backend`) and Frontend (`darrenhnovecom/nic1-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of nic1.novecom.com.au](https://github.com/darrenhnovecom/nic1/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/nic1.novecom.com.au.yml` stack.
